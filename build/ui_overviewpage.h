...
""));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Ohmcoin network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelImmature->setToolTip(QApplication::translate("OverviewPage", "Minted balance that has not yet matured", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_61->setText(QApplication::translate("OverviewPage", "Status:", Q_NULLPTR));
        ...
        labelAnonymized->setText(QApplication::translate("OverviewPage", "0 Ohmcoin", Q_NULLPTR));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", Q_NULLPTR));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 Ohmcoin / 0 Rounds", Q_NULLPTR));
        label_9->setText(QApplication::translate("OverviewPage", "Submitted Denom:", Q_NULLPTR));
#ifndef QT_NO_STATUSTIP
        labelSubmittedDenom->setStatusTip(QApplication::translate("OverviewPage", "The denominations you submitted to the Adrenaline Node. To mix, other users must submit the exact same denominations.", Q_NULLPTR));
        ...
        toggleDarksend->setText(QApplication::translate("OverviewPage", "Start/Stop", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Ohmcoin network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
