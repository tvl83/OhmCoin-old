...
public:
    ...
    {
        AdrenalineNodeConfigDialog->setWindowTitle(QApplication::translate("AdrenalineNodeConfigDialog", "Masternodes Node Configuration Template", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        detailText->setToolTip(QApplication::translate("AdrenalineNodeConfigDialog", "<html><head/><body><p>This pane shows an example ohmcoin.conf template with the necessary masternode settings.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
