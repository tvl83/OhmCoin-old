...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Ohmcoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Ohmcoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2014 The Ohmcoin developers", Q_NULLPTR));
