...
const string strMessageMagic = "Ohmcoin Signed Message:\n";
...
int nTargetSpacing = 30; //---------> 30 seconds per  block

static int64_t nTargetTimespan = 200 * 60;  // //---------> Look at last 200 minutes
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
	...
	LogPrintf("ConnectBlock() : coinbase reward exceeded (actual=%d vs calculated=%d)",
                   vtx[0].GetValueOut(),
                   nReward);
...
#ifdef ENABLE_WALLET
// ohmcoin: attempt to generate suitable proof-of-stake
