...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Genesis Ohmcoin 10.10.2017";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1507654709, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1507654709;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 443175;                                        
...
if (false )
        ...
        assert(hashGenesisBlock == uint256("0x52fb679c23985e9606ad832288e55ca3ddf72ff726193115d1067a3f5655461c"));
